...
import (
	v1 "github.com/hbttundar/scg-contracts/gen/go/proto/scg/event_log/v1"
...
type ProvenanceRecord struct {
	...
	UnitUuid string `protobuf:"bytes,1,opt,name=unit_uuid,json=unitUuid,proto3" json:"unit_uuid,omitempty"`
	// Collection of all events related to this unit
	EventLogs     []*v1.EventLogEntry `protobuf:"bytes,2,rep,name=event_logs,json=eventLogs,proto3" json:"event_logs,omitempty"`
...
const file_proto_scg_provenance_v1_events_proto_rawDesc = "" +
	"\n" +
	"$proto/scg/provenance/v1/events.proto\x12\x17proto.scg.provenance.v1\x1a#proto/scg/event_log/v1/events.proto\"u\n" +
	"\x10ProvenanceRecord\x12\x1b\n" +
	"\tunit_uuid\x18\x01 \x01(\tR\bunitUuid\x12D\n" +
	"\n" +
	"event_logs\x18\x02 \x03(\v2%.proto.scg.event_log.v1.EventLogEntryR\teventLogsBPZNgithub.com/hbttundar/scg-contracts/gen/go/proto/scg/provenance/v1;provenancev1b\x06proto3"
