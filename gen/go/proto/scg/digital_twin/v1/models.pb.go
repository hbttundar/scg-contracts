...
type DigitalTwin struct {
	...
	DigitalTwinUuid string                 `protobuf:"bytes,1,opt,name=digital_twin_uuid,json=digitalTwinUuid,proto3" json:"digital_twin_uuid,omitempty"`
	UnitUuid        string                 `protobuf:"bytes,2,opt,name=unit_uuid,json=unitUuid,proto3" json:"unit_uuid,omitempty"`
	ModelType       DigitalTwinModelType   `protobuf:"varint,3,opt,name=model_type,json=modelType,proto3,enum=proto.scg.digital_twin.v1.DigitalTwinModelType" json:"model_type,omitempty"`
...
const file_proto_scg_digital_twin_v1_models_proto_rawDesc = "" +
	"\n" +
	"&proto/scg/digital_twin/v1/models.proto\x12\x19proto.scg.digital_twin.v1\x1a proto/scg/shared/v1/events.proto\x1a%proto/scg/digital_twin/v1/enums.proto\"\xcd\x02\n" +
	"\vDigitalTwin\x12*\n" +
	"\x11digital_twin_uuid\x18\x01 \x01(\tR\x0fdigitalTwinUuid\x12\x1b\n" +
	"\tunit_uuid\x18\x02 \x01(\tR\bunitUuid\x12N\n" +
	"\n" +
	"model_type\x18\x03 \x01(\x0e2/.proto.scg.digital_twin.v1.DigitalTwinModelTypeR\tmodelType\x12\x16\n" +
	...
	"\x11digital_twin_uuid\x18\x01 \x01(\tR\x0fdigitalTwinUuid\x12\x1f\n" +
	...
	"\x04meta\x18\x06 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04metaBSZQgithub.com/hbttundar/scg-contracts/gen/go/proto/scg/digital_twin/v1;digitaltwinv1b\x06proto3"
