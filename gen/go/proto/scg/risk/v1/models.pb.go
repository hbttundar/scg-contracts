...
type Risk struct {
	...
	ImpactTypes []RiskImpactType       `protobuf:"varint,8,rep,packed,name=impact_types,json=impactTypes,proto3,enum=proto.scg.risk.v1.RiskImpactType" json:"impact_types,omitempty"`
	// The entity this risk is associated with (could be a partner, consignment, unit, etc.)
	EntityType string `protobuf:"bytes,9,opt,name=entity_type,json=entityType,proto3" json:"entity_type,omitempty"` // "partner", "consignment", "unit", etc.
	EntityUuid string `protobuf:"bytes,10,opt,name=entity_uuid,json=entityUuid,proto3" json:"entity_uuid,omitempty"`
	// Risk scoring
	RiskScore        float64              `protobuf:"fixed64,11,opt,name=risk_score,json=riskScore,proto3" json:"risk_score,omitempty"` // Calculated risk score (severity * probability)
	AssessmentMethod RiskAssessmentMethod `protobuf:"varint,12,opt,name=assessment_method,json=assessmentMethod,proto3,enum=proto.scg.risk.v1.RiskAssessmentMethod" json:"assessment_method,omitempty"`
	// Ownership and tracking
	OwnerUuid      string                 `protobuf:"bytes,13,opt,name=owner_uuid,json=ownerUuid,proto3" json:"owner_uuid,omitempty"` // User responsible for managing this risk
	IdentifiedAt   *timestamppb.Timestamp `protobuf:"bytes,14,opt,name=identified_at,json=identifiedAt,proto3" json:"identified_at,omitempty"`
	LastAssessedAt *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=last_assessed_at,json=lastAssessedAt,proto3" json:"last_assessed_at,omitempty"`
	NextReviewDate *timestamppb.Timestamp `protobuf:"bytes,16,opt,name=next_review_date,json=nextReviewDate,proto3" json:"next_review_date,omitempty"`
...
type RiskMitigationPlan struct {
	...
	ActualCompletionDate *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=actual_completion_date,json=actualCompletionDate,proto3" json:"actual_completion_date,omitempty"`
	// Ownership and tracking
	OwnerUuid            string                  `protobuf:"bytes,9,opt,name=owner_uuid,json=ownerUuid,proto3" json:"owner_uuid,omitempty"`
	StakeholderUuids     []string                `protobuf:"bytes,10,rep,name=stakeholder_uuids,json=stakeholderUuids,proto3" json:"stakeholder_uuids,omitempty"`
	EstimatedCost        float64                 `protobuf:"fixed64,11,opt,name=estimated_cost,json=estimatedCost,proto3" json:"estimated_cost,omitempty"`
	CostCurrency         string                  `protobuf:"bytes,12,opt,name=cost_currency,json=costCurrency,proto3" json:"cost_currency,omitempty"`
	CompletionPercentage int32                   `protobuf:"varint,13,opt,name=completion_percentage,json=completionPercentage,proto3" json:"completion_percentage,omitempty"`
...
type RiskMitigationAction struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	Uuid               string                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	MitigationPlanUuid string                 `protobuf:"bytes,2,opt,name=mitigation_plan_uuid,json=mitigationPlanUuid,proto3" json:"mitigation_plan_uuid,omitempty"`
	Description        string                 `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
...
type RiskIncident struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Uuid              string                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	RiskUuid          string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"` // Reference to the original risk
	Title             string                 `protobuf:"bytes,3,opt,name=title,proto3" json:"title,omitempty"`
	Description       string                 `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	ActualSeverity    RiskSeverity           `protobuf:"varint,5,opt,name=actual_severity,json=actualSeverity,proto3,enum=proto.scg.risk.v1.RiskSeverity" json:"actual_severity,omitempty"`
	ActualImpactTypes []RiskImpactType       `protobuf:"varint,6,rep,packed,name=actual_impact_types,json=actualImpactTypes,proto3,enum=proto.scg.risk.v1.RiskImpactType" json:"actual_impact_types,omitempty"`
	// Impact details
	ImpactDescription       string  `protobuf:"bytes,7,opt,name=impact_description,json=impactDescription,proto3" json:"impact_description,omitempty"`
	FinancialImpact         float64 `protobuf:"fixed64,8,opt,name=financial_impact,json=financialImpact,proto3" json:"financial_impact,omitempty"`
	FinancialImpactCurrency string  `protobuf:"bytes,9,opt,name=financial_impact_currency,json=financialImpactCurrency,proto3" json:"financial_impact_currency,omitempty"`
	// Timeline
	...
	AffectedEntityUuids []string               `protobuf:"bytes,15,rep,name=affected_entity_uuids,json=affectedEntityUuids,proto3" json:"affected_entity_uuids,omitempty"`
	ResolutionSummary   string                 `protobuf:"bytes,16,opt,name=resolution_summary,json=resolutionSummary,proto3" json:"resolution_summary,omitempty"`
	LessonsLearned      string                 `protobuf:"bytes,17,opt,name=lessons_learned,json=lessonsLearned,proto3" json:"lessons_learned,omitempty"`
...
type RiskAssessment struct {
	...
	// Scope
	ScopeType string `protobuf:"bytes,5,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"` // "partner", "region", "product_line", "global"
	ScopeUuid string `protobuf:"bytes,6,opt,name=scope_uuid,json=scopeUuid,proto3" json:"scope_uuid,omitempty"` // UUID of the entity being assessed, if applicable
	// Timeline
	AssessmentDate     *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=assessment_date,json=assessmentDate,proto3" json:"assessment_date,omitempty"`
	NextAssessmentDate *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=next_assessment_date,json=nextAssessmentDate,proto3" json:"next_assessment_date,omitempty"`
	// Results
	IdentifiedRiskUuids []string `protobuf:"bytes,9,rep,name=identified_risk_uuids,json=identifiedRiskUuids,proto3" json:"identified_risk_uuids,omitempty"`
	...
	// Ownership and tracking
	ConductedBy   string                 `protobuf:"bytes,12,opt,name=conducted_by,json=conductedBy,proto3" json:"conducted_by,omitempty"` // User UUID
	ApprovedBy    string                 `protobuf:"bytes,13,opt,name=approved_by,json=approvedBy,proto3" json:"approved_by,omitempty"`    // User UUID
...
type RiskMonitoringRule struct {
	...
	// Rule criteria
	Category       RiskCategory    `protobuf:"varint,4,opt,name=category,proto3,enum=proto.scg.risk.v1.RiskCategory" json:"category,omitempty"`
	MinSeverity    RiskSeverity    `protobuf:"varint,5,opt,name=min_severity,json=minSeverity,proto3,enum=proto.scg.risk.v1.RiskSeverity" json:"min_severity,omitempty"`
	MinProbability RiskProbability `protobuf:"varint,6,opt,name=min_probability,json=minProbability,proto3,enum=proto.scg.risk.v1.RiskProbability" json:"min_probability,omitempty"`
	...
	MonitoringFrequencyDays int32 `protobuf:"varint,8,opt,name=monitoring_frequency_days,json=monitoringFrequencyDays,proto3" json:"monitoring_frequency_days,omitempty"` // How often to check
	Active                  bool  `protobuf:"varint,9,opt,name=active,proto3" json:"active,omitempty"`
	// Actions
	AutoEscalate               bool                   `protobuf:"varint,10,opt,name=auto_escalate,json=autoEscalate,proto3" json:"auto_escalate,omitempty"`
	NotificationRecipientUuids []string               `protobuf:"bytes,11,rep,name=notification_recipient_uuids,json=notificationRecipientUuids,proto3" json:"notification_recipient_uuids,omitempty"`
...
type RiskKPI struct {
	...
	Name            string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description     string                 `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	MetricType      string                 `protobuf:"bytes,4,opt,name=metric_type,json=metricType,proto3" json:"metric_type,omitempty"` // "count", "percentage", "score", etc.
	...
	PreviousValue   float64                `protobuf:"fixed64,7,opt,name=previous_value,json=previousValue,proto3" json:"previous_value,omitempty"`
	MeasurementDate *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=measurement_date,json=measurementDate,proto3" json:"measurement_date,omitempty"`
...
const file_proto_scg_risk_v1_models_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/scg/risk/v1/models.proto\x12\x11proto.scg.risk.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dproto/scg/risk/v1/enums.proto\"\xa6\a\n" +
	"\x04Risk\x12\x12\n" +
	...
	"\x06status\x18\a \x01(\x0e2\x1d.proto.scg.risk.v1.RiskStatusR\x06status\x12D\n" +
	"\fimpact_types\x18\b \x03(\x0e2!.proto.scg.risk.v1.RiskImpactTypeR\vimpactTypes\x12\x1f\n" +
	...
	"entityUuid\x12\x1d\n" +
	"\n" +
	"risk_score\x18\v \x01(\x01R\triskScore\x12T\n" +
	"\x11assessment_method\x18\f \x01(\x0e2'.proto.scg.risk.v1.RiskAssessmentMethodR\x10assessmentMethod\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\r \x01(\tR\townerUuid\x12?\n" +
	"\ridentified_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\fidentifiedAt\x12D\n" +
	"\x10last_assessed_at\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampR\x0elastAssessedAt\x12D\n" +
	"\x10next_review_date\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\x0enextReviewDate\x129\n" +
	"\n" +
	"created_at\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x9d\x06\n" +
	...
	"\x06status\x18\x05 \x01(\x0e2#.proto.scg.risk.v1.MitigationStatusR\x06status\x129\n" +
	"\n" +
	"start_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tstartDate\x12P\n" +
	"\x16target_completion_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x14targetCompletionDate\x12P\n" +
	"\x16actual_completion_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x14actualCompletionDate\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\t \x01(\tR\townerUuid\x12+\n" +
	"\x11stakeholder_uuids\x18\n" +
	" \x03(\tR\x10stakeholderUuids\x12%\n" +
	"\x0eestimated_cost\x18\v \x01(\x01R\restimatedCost\x12#\n" +
	"\rcost_currency\x18\f \x01(\tR\fcostCurrency\x123\n" +
	"\x15completion_percentage\x18\r \x01(\x05R\x14completionPercentage\x12A\n" +
	"\aactions\x18\x0e \x03(\v2'.proto.scg.risk.v1.RiskMitigationActionR\aactions\x129\n" +
	"\n" +
	"created_at\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xb7\x03\n" +
	"\x14RiskMitigationAction\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x120\n" +
	"\x14mitigation_plan_uuid\x18\x02 \x01(\tR\x12mitigationPlanUuid\x12 \n" +
	...
	"\n" +
	"updated_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x9a\a\n" +
	"\fRiskIncident\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12H\n" +
	"\x0factual_severity\x18\x05 \x01(\x0e2\x1f.proto.scg.risk.v1.RiskSeverityR\x0eactualSeverity\x12Q\n" +
	"\x13actual_impact_types\x18\x06 \x03(\x0e2!.proto.scg.risk.v1.RiskImpactTypeR\x11actualImpactTypes\x12-\n" +
	"\x12impact_description\x18\a \x01(\tR\x11impactDescription\x12)\n" +
	"\x10financial_impact\x18\b \x01(\x01R\x0ffinancialImpact\x12:\n" +
	"\x19financial_impact_currency\x18\t \x01(\tR\x17financialImpactCurrency\x12;\n" +
	"\voccurred_at\x18\n" +
	...
	"\n" +
	"owner_uuid\x18\x0e \x01(\tR\townerUuid\x122\n" +
	"\x15affected_entity_uuids\x18\x0f \x03(\tR\x13affectedEntityUuids\x12-\n" +
	"\x12resolution_summary\x18\x10 \x01(\tR\x11resolutionSummary\x12'\n" +
	"\x0flessons_learned\x18\x11 \x01(\tR\x0elessonsLearned\x129\n" +
	"\n" +
	"created_at\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x13 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x9e\x05\n" +
	"\x0eRiskAssessment\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12?\n" +
	"\x06method\x18\x04 \x01(\x0e2'.proto.scg.risk.v1.RiskAssessmentMethodR\x06method\x12\x1d\n" +
	"\n" +
	"scope_type\x18\x05 \x01(\tR\tscopeType\x12\x1d\n" +
	"\n" +
	"scope_uuid\x18\x06 \x01(\tR\tscopeUuid\x12C\n" +
	"\x0fassessment_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0eassessmentDate\x12L\n" +
	"\x14next_assessment_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x12nextAssessmentDate\x122\n" +
	"\x15identified_risk_uuids\x18\t \x03(\tR\x13identifiedRiskUuids\x12\x18\n" +
	"\asummary\x18\n" +
	" \x01(\tR\asummary\x12(\n" +
	"\x0frecommendations\x18\v \x01(\tR\x0frecommendations\x12!\n" +
	"\fconducted_by\x18\f \x01(\tR\vconductedBy\x12\x1f\n" +
	"\vapproved_by\x18\r \x01(\tR\n" +
	"approvedBy\x129\n" +
	"\n" +
	"created_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x83\x05\n" +
	"\x12RiskMonitoringRule\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12;\n" +
	"\bcategory\x18\x04 \x01(\x0e2\x1f.proto.scg.risk.v1.RiskCategoryR\bcategory\x12B\n" +
	"\fmin_severity\x18\x05 \x01(\x0e2\x1f.proto.scg.risk.v1.RiskSeverityR\vminSeverity\x12K\n" +
	"\x0fmin_probability\x18\x06 \x01(\x0e2\".proto.scg.risk.v1.RiskProbabilityR\x0eminProbability\x12$\n" +
	"\x0emin_risk_score\x18\a \x01(\x01R\fminRiskScore\x12:\n" +
	"\x19monitoring_frequency_days\x18\b \x01(\x05R\x17monitoringFrequencyDays\x12\x16\n" +
	"\x06active\x18\t \x01(\bR\x06active\x12#\n" +
	"\rauto_escalate\x18\n" +
	" \x01(\bR\fautoEscalate\x12@\n" +
	"\x1cnotification_recipient_uuids\x18\v \x03(\tR\x1anotificationRecipientUuids\x129\n" +
	"\n" +
	"created_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xb8\x03\n" +
	"\aRiskKPI\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\x0eprevious_value\x18\a \x01(\x01R\rpreviousValue\x12E\n" +
	"\x10measurement_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x0fmeasurementDate\x12\x16\n" +
	"\x06status\x18\t \x01(\tR\x06status\x129\n" +
	"\n" +
	"created_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtBDZBgithub.com/hbttundar/scg-contracts/gen/go/proto/scg/risk/v1;riskv1b\x06proto3"
