...
type RiskIdentified struct {
	...
	RiskUuid      string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	...
	IdentifiedBy  string                 `protobuf:"bytes,9,opt,name=identified_by,json=identifiedBy,proto3" json:"identified_by,omitempty"`
	IdentifiedAt  *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=identified_at,json=identifiedAt,proto3" json:"identified_at,omitempty"`
...
type RiskAssessed struct {
	...
	AssessmentMethod string                 `protobuf:"bytes,6,opt,name=assessment_method,json=assessmentMethod,proto3" json:"assessment_method,omitempty"`
	AssessedBy       string                 `protobuf:"bytes,7,opt,name=assessed_by,json=assessedBy,proto3" json:"assessed_by,omitempty"`
...
type RiskSeverityChanged struct {
	...
	Meta             *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid         string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	PreviousSeverity string                 `protobuf:"bytes,3,opt,name=previous_severity,json=previousSeverity,proto3" json:"previous_severity,omitempty"`
	NewSeverity      string                 `protobuf:"bytes,4,opt,name=new_severity,json=newSeverity,proto3" json:"new_severity,omitempty"`
	NewRiskScore     float64                `protobuf:"fixed64,5,opt,name=new_risk_score,json=newRiskScore,proto3" json:"new_risk_score,omitempty"`
...
type RiskProbabilityChanged struct {
	...
	Meta                *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid            string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	PreviousProbability string                 `protobuf:"bytes,3,opt,name=previous_probability,json=previousProbability,proto3" json:"previous_probability,omitempty"`
	NewProbability      string                 `protobuf:"bytes,4,opt,name=new_probability,json=newProbability,proto3" json:"new_probability,omitempty"`
	NewRiskScore        float64                `protobuf:"fixed64,5,opt,name=new_risk_score,json=newRiskScore,proto3" json:"new_risk_score,omitempty"`
	ChangedBy           string                 `protobuf:"bytes,6,opt,name=changed_by,json=changedBy,proto3" json:"changed_by,omitempty"`
	ChangedAt           *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=changed_at,json=changedAt,proto3" json:"changed_at,omitempty"`
	unknownFields       protoimpl.UnknownFields
...
type RiskMitigated struct {
	...
	Meta               *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid           string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	MitigationPlanUuid string                 `protobuf:"bytes,3,opt,name=mitigation_plan_uuid,json=mitigationPlanUuid,proto3" json:"mitigation_plan_uuid,omitempty"`
	MitigatedBy        string                 `protobuf:"bytes,4,opt,name=mitigated_by,json=mitigatedBy,proto3" json:"mitigated_by,omitempty"`
	MitigatedAt        *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=mitigated_at,json=mitigatedAt,proto3" json:"mitigated_at,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type RiskTransferred struct {
	...
	Meta           *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid       string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	TransferMethod string                 `protobuf:"bytes,3,opt,name=transfer_method,json=transferMethod,proto3" json:"transfer_method,omitempty"` // "insurance", "outsourcing", etc.
	TransferredTo  string                 `protobuf:"bytes,4,opt,name=transferred_to,json=transferredTo,proto3" json:"transferred_to,omitempty"`    // Entity the risk was transferred to
	TransferredBy  string                 `protobuf:"bytes,5,opt,name=transferred_by,json=transferredBy,proto3" json:"transferred_by,omitempty"`
	TransferredAt  *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=transferred_at,json=transferredAt,proto3" json:"transferred_at,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type RiskMaterialized struct {
	...
	Meta              *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid          string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	RiskIncidentUuid  string                 `protobuf:"bytes,3,opt,name=risk_incident_uuid,json=riskIncidentUuid,proto3" json:"risk_incident_uuid,omitempty"`
	Severity          string                 `protobuf:"bytes,4,opt,name=severity,proto3" json:"severity,omitempty"`
	ImpactDescription string                 `protobuf:"bytes,5,opt,name=impact_description,json=impactDescription,proto3" json:"impact_description,omitempty"`
	MaterializedAt    *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=materialized_at,json=materializedAt,proto3" json:"materialized_at,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type RiskMitigationPlanCreated struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Meta                 *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskPlanUuid         string                 `protobuf:"bytes,2,opt,name=risk_plan_uuid,json=riskPlanUuid,proto3" json:"risk_plan_uuid,omitempty"`
	RiskUuid             string                 `protobuf:"bytes,3,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	...
	TargetCompletionDate *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=target_completion_date,json=targetCompletionDate,proto3" json:"target_completion_date,omitempty"`
...
type RiskMitigationActionAdded struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Meta           *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskActionUuid string                 `protobuf:"bytes,2,opt,name=risk_action_uuid,json=riskActionUuid,proto3" json:"risk_action_uuid,omitempty"`
	RiskPlanUuid   string                 `protobuf:"bytes,3,opt,name=risk_plan_uuid,json=riskPlanUuid,proto3" json:"risk_plan_uuid,omitempty"`
...
type RiskMitigationActionCompleted struct {
	...
	RiskActionUuid string                 `protobuf:"bytes,2,opt,name=risk_action_uuid,json=riskActionUuid,proto3" json:"risk_action_uuid,omitempty"`
	RiskPlanUuid   string                 `protobuf:"bytes,3,opt,name=risk_plan_uuid,json=riskPlanUuid,proto3" json:"risk_plan_uuid,omitempty"`
	CompletedBy    string                 `protobuf:"bytes,4,opt,name=completed_by,json=completedBy,proto3" json:"completed_by,omitempty"`
...
type RiskIncidentCreated struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Meta             *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskIncidentUuid string                 `protobuf:"bytes,2,opt,name=risk_incident_uuid,json=riskIncidentUuid,proto3" json:"risk_incident_uuid,omitempty"`
	RiskUuid         string                 `protobuf:"bytes,3,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	Title            string                 `protobuf:"bytes,4,opt,name=title,proto3" json:"title,omitempty"`
	Severity         string                 `protobuf:"bytes,5,opt,name=severity,proto3" json:"severity,omitempty"`
	ImpactTypes      []string               `protobuf:"bytes,6,rep,name=impact_types,json=impactTypes,proto3" json:"impact_types,omitempty"`
...
type RiskIncidentImpactUpdated struct {
	...
	FinancialImpact         float64                `protobuf:"fixed64,4,opt,name=financial_impact,json=financialImpact,proto3" json:"financial_impact,omitempty"`
	FinancialImpactCurrency string                 `protobuf:"bytes,5,opt,name=financial_impact_currency,json=financialImpactCurrency,proto3" json:"financial_impact_currency,omitempty"`
...
type RiskAssessmentCreated struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	Meta               *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskAssessmentUuid string                 `protobuf:"bytes,2,opt,name=risk_assessment_uuid,json=riskAssessmentUuid,proto3" json:"risk_assessment_uuid,omitempty"`
	Name               string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	...
	AssessmentMethod   string                 `protobuf:"bytes,6,opt,name=assessment_method,json=assessmentMethod,proto3" json:"assessment_method,omitempty"`
	ConductedBy        string                 `protobuf:"bytes,7,opt,name=conducted_by,json=conductedBy,proto3" json:"conducted_by,omitempty"`
	AssessmentDate     *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=assessment_date,json=assessmentDate,proto3" json:"assessment_date,omitempty"`
	CreatedAt          *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type RiskAssessmentCompleted struct {
	...
	Meta               *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskAssessmentUuid string                 `protobuf:"bytes,2,opt,name=risk_assessment_uuid,json=riskAssessmentUuid,proto3" json:"risk_assessment_uuid,omitempty"`
	RisksIdentified    int32                  `protobuf:"varint,3,opt,name=risks_identified,json=risksIdentified,proto3" json:"risks_identified,omitempty"`
...
type RiskMonitoringRuleCreated struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	Meta                    *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskRuleUuid            string                 `protobuf:"bytes,2,opt,name=risk_rule_uuid,json=riskRuleUuid,proto3" json:"risk_rule_uuid,omitempty"`
	Name                    string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Category                string                 `protobuf:"bytes,4,opt,name=category,proto3" json:"category,omitempty"`
	MinSeverity             string                 `protobuf:"bytes,5,opt,name=min_severity,json=minSeverity,proto3" json:"min_severity,omitempty"`
	MinProbability          string                 `protobuf:"bytes,6,opt,name=min_probability,json=minProbability,proto3" json:"min_probability,omitempty"`
	MinRiskScore            float64                `protobuf:"fixed64,7,opt,name=min_risk_score,json=minRiskScore,proto3" json:"min_risk_score,omitempty"`
	MonitoringFrequencyDays int32                  `protobuf:"varint,8,opt,name=monitoring_frequency_days,json=monitoringFrequencyDays,proto3" json:"monitoring_frequency_days,omitempty"`
	CreatedAt               *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type RiskMonitoringRuleDeactivated struct {
	...
	RiskRuleUuid  string                 `protobuf:"bytes,2,opt,name=risk_rule_uuid,json=riskRuleUuid,proto3" json:"risk_rule_uuid,omitempty"`
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`
	DeactivatedBy string                 `protobuf:"bytes,4,opt,name=deactivated_by,json=deactivatedBy,proto3" json:"deactivated_by,omitempty"`
	DeactivatedAt *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=deactivated_at,json=deactivatedAt,proto3" json:"deactivated_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RiskThresholdExceeded struct {
	...
	Meta          *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskUuid      string                 `protobuf:"bytes,2,opt,name=risk_uuid,json=riskUuid,proto3" json:"risk_uuid,omitempty"`
	RiskRuleUuid  string                 `protobuf:"bytes,3,opt,name=risk_rule_uuid,json=riskRuleUuid,proto3" json:"risk_rule_uuid,omitempty"`
	ThresholdType string                 `protobuf:"bytes,4,opt,name=threshold_type,json=thresholdType,proto3" json:"threshold_type,omitempty"` // "severity", "probability", "score"
...
type RiskKPICreated struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Meta          *v1.EventEnvelope      `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	RiskKpiUuid   string                 `protobuf:"bytes,2,opt,name=risk_kpi_uuid,json=riskKpiUuid,proto3" json:"risk_kpi_uuid,omitempty"`
	Name          string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
...
type RiskKPIUpdated struct {
	...
	MeasurementDate *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=measurement_date,json=measurementDate,proto3" json:"measurement_date,omitempty"`
...
const file_proto_scg_risk_v1_events_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/scg/risk/v1/events.proto\x12\x11proto.scg.risk.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a proto/scg/shared/v1/events.proto\"\xfb\x02\n" +
	"\x0eRiskIdentified\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x04 \x01(\tR\bcategory\x12\x1a\n" +
	"\bseverity\x18\x05 \x01(\tR\bseverity\x12 \n" +
	"\vprobability\x18\x06 \x01(\tR\vprobability\x12\x1f\n" +
	"\ventity_type\x18\a \x01(\tR\n" +
	"entityType\x12\x1f\n" +
	"\ventity_uuid\x18\b \x01(\tR\n" +
	"entityUuid\x12#\n" +
	"\ridentified_by\x18\t \x01(\tR\fidentifiedBy\x12?\n" +
	"\ridentified_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\fidentifiedAt\"\xcb\x02\n" +
	"\fRiskAssessed\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12\x1a\n" +
	"\bseverity\x18\x03 \x01(\tR\bseverity\x12 \n" +
	"\vprobability\x18\x04 \x01(\tR\vprobability\x12\x1d\n" +
	"\n" +
	"risk_score\x18\x05 \x01(\x01R\triskScore\x12+\n" +
	"\x11assessment_method\x18\x06 \x01(\tR\x10assessmentMethod\x12\x1f\n" +
	"\vassessed_by\x18\a \x01(\tR\n" +
	"assessedBy\x12;\n" +
	"\vassessed_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"assessedAt\"\xba\x02\n" +
	"\x13RiskSeverityChanged\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12+\n" +
	"\x11previous_severity\x18\x03 \x01(\tR\x10previousSeverity\x12!\n" +
	"\fnew_severity\x18\x04 \x01(\tR\vnewSeverity\x12$\n" +
	"\x0enew_risk_score\x18\x05 \x01(\x01R\fnewRiskScore\x12\x1d\n" +
	"\n" +
	"changed_by\x18\x06 \x01(\tR\tchangedBy\x129\n" +
	"\n" +
	"changed_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xc9\x02\n" +
	"\x16RiskProbabilityChanged\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x121\n" +
	"\x14previous_probability\x18\x03 \x01(\tR\x13previousProbability\x12'\n" +
	"\x0fnew_probability\x18\x04 \x01(\tR\x0enewProbability\x12$\n" +
	"\x0enew_risk_score\x18\x05 \x01(\x01R\fnewRiskScore\x12\x1d\n" +
	"\n" +
	"changed_by\x18\x06 \x01(\tR\tchangedBy\x129\n" +
	"\n" +
	"changed_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xa2\x02\n" +
	...
	"changed_by\x18\x06 \x01(\tR\tchangedBy\x129\n" +
	"\n" +
	"changed_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xf8\x01\n" +
	"\rRiskMitigated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x120\n" +
	"\x14mitigation_plan_uuid\x18\x03 \x01(\tR\x12mitigationPlanUuid\x12!\n" +
	"\fmitigated_by\x18\x04 \x01(\tR\vmitigatedBy\x12=\n" +
	"\fmitigated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vmitigatedAt\"\xd9\x01\n" +
	"\fRiskAccepted\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12\x16\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12'\n" +
	"\x0ftransfer_method\x18\x03 \x01(\tR\x0etransferMethod\x12%\n" +
	"\x0etransferred_to\x18\x04 \x01(\tR\rtransferredTo\x12%\n" +
	"\x0etransferred_by\x18\x05 \x01(\tR\rtransferredBy\x12A\n" +
	"\x0etransferred_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\rtransferredAt\"\xa5\x02\n" +
	"\x10RiskMaterialized\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12,\n" +
	"\x12risk_incident_uuid\x18\x03 \x01(\tR\x10riskIncidentUuid\x12\x1a\n" +
	"\bseverity\x18\x04 \x01(\tR\bseverity\x12-\n" +
	"\x12impact_description\x18\x05 \x01(\tR\x11impactDescription\x12C\n" +
	"\x0fmaterialized_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0ematerializedAt\"\x91\x03\n" +
	"\x19RiskMitigationPlanCreated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_plan_uuid\x18\x02 \x01(\tR\friskPlanUuid\x12\x1b\n" +
	"\trisk_uuid\x18\x03 \x01(\tR\briskUuid\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\x05 \x01(\tR\townerUuid\x129\n" +
	"\n" +
	"start_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tstartDate\x12P\n" +
	"\x16target_completion_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x14targetCompletionDate\x129\n" +
	"\n" +
	"created_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xde\x02\n" +
	"\x19RiskMitigationPlanUpdated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_plan_uuid\x18\x02 \x01(\tR\friskPlanUuid\x12f\n" +
	"\x0eupdated_fields\x18\x03 \x03(\v2?.proto.scg.risk.v1.RiskMitigationPlanUpdated.UpdatedFieldsEntryR\rupdatedFields\x129\n" +
	"\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_plan_uuid\x18\x02 \x01(\tR\friskPlanUuid\x12'\n" +
	"\x0fprevious_status\x18\x03 \x01(\tR\x0epreviousStatus\x12\x1d\n" +
	"\n" +
	"new_status\x18\x04 \x01(\tR\tnewStatus\x12\x1d\n" +
	"\n" +
	"changed_by\x18\x05 \x01(\tR\tchangedBy\x129\n" +
	"\n" +
	"changed_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xd2\x02\n" +
	"\x19RiskMitigationActionAdded\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12(\n" +
	"\x10risk_action_uuid\x18\x02 \x01(\tR\x0eriskActionUuid\x12$\n" +
	"\x0erisk_plan_uuid\x18\x03 \x01(\tR\friskPlanUuid\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\x05 \x01(\tR\townerUuid\x125\n" +
	"\bdue_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\adueDate\x125\n" +
	"\badded_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\aaddedAt\"\x89\x02\n" +
	"\x1dRiskMitigationActionCompleted\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12(\n" +
	"\x10risk_action_uuid\x18\x02 \x01(\tR\x0eriskActionUuid\x12$\n" +
	"\x0erisk_plan_uuid\x18\x03 \x01(\tR\friskPlanUuid\x12!\n" +
	"\fcompleted_by\x18\x04 \x01(\tR\vcompletedBy\x12=\n" +
	"\fcompleted_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vcompletedAt\"\xa2\x03\n" +
	"\x13RiskIncidentCreated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12,\n" +
	"\x12risk_incident_uuid\x18\x02 \x01(\tR\x10riskIncidentUuid\x12\x1b\n" +
	"\trisk_uuid\x18\x03 \x01(\tR\briskUuid\x12\x14\n" +
	"\x05title\x18\x04 \x01(\tR\x05title\x12\x1a\n" +
	"\bseverity\x18\x05 \x01(\tR\bseverity\x12!\n" +
	"\fimpact_types\x18\x06 \x03(\tR\vimpactTypes\x12;\n" +
	"\voccurred_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"occurredAt\x12;\n" +
	"\vdetected_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"detectedAt\x129\n" +
	"\n" +
	"created_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xa3\x02\n" +
	"\x19RiskIncidentStatusChanged\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12,\n" +
	"\x12risk_incident_uuid\x18\x02 \x01(\tR\x10riskIncidentUuid\x12'\n" +
	"\x0fprevious_status\x18\x03 \x01(\tR\x0epreviousStatus\x12\x1d\n" +
	"\n" +
	"new_status\x18\x04 \x01(\tR\tnewStatus\x12\x1d\n" +
	"\n" +
	"changed_by\x18\x05 \x01(\tR\tchangedBy\x129\n" +
	"\n" +
	"changed_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\x89\x02\n" +
	"\x14RiskIncidentResolved\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12,\n" +
	"\x12risk_incident_uuid\x18\x02 \x01(\tR\x10riskIncidentUuid\x12-\n" +
	"\x12resolution_summary\x18\x03 \x01(\tR\x11resolutionSummary\x12\x1f\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12,\n" +
	"\x12risk_incident_uuid\x18\x02 \x01(\tR\x10riskIncidentUuid\x12-\n" +
	"\x12impact_description\x18\x03 \x01(\tR\x11impactDescription\x12)\n" +
	"\x10financial_impact\x18\x04 \x01(\x01R\x0ffinancialImpact\x12:\n" +
	"\x19financial_impact_currency\x18\x05 \x01(\tR\x17financialImpactCurrency\x129\n" +
	"\n" +
	"updated_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xa3\x03\n" +
	"\x15RiskAssessmentCreated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x120\n" +
	"\x14risk_assessment_uuid\x18\x02 \x01(\tR\x12riskAssessmentUuid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"scope_type\x18\x04 \x01(\tR\tscopeType\x12\x1d\n" +
	"\n" +
	"scope_uuid\x18\x05 \x01(\tR\tscopeUuid\x12+\n" +
	"\x11assessment_method\x18\x06 \x01(\tR\x10assessmentMethod\x12!\n" +
	"\fconducted_by\x18\a \x01(\tR\vconductedBy\x12C\n" +
	"\x0fassessment_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x0eassessmentDate\x129\n" +
	"\n" +
	"created_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xaa\x02\n" +
	"\x17RiskAssessmentCompleted\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x120\n" +
	"\x14risk_assessment_uuid\x18\x02 \x01(\tR\x12riskAssessmentUuid\x12)\n" +
	"\x10risks_identified\x18\x03 \x01(\x05R\x0frisksIdentified\x12\x18\n" +
	"\asummary\x18\x04 \x01(\tR\asummary\x12!\n" +
	"\fcompleted_by\x18\x05 \x01(\tR\vcompletedBy\x12=\n" +
	"\fcompleted_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vcompletedAt\"\xe0\x01\n" +
	"\x16RiskAssessmentApproved\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x120\n" +
	"\x14risk_assessment_uuid\x18\x02 \x01(\tR\x12riskAssessmentUuid\x12\x1f\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_rule_uuid\x18\x02 \x01(\tR\friskRuleUuid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x04 \x01(\tR\bcategory\x12!\n" +
	"\fmin_severity\x18\x05 \x01(\tR\vminSeverity\x12'\n" +
	"\x0fmin_probability\x18\x06 \x01(\tR\x0eminProbability\x12$\n" +
	"\x0emin_risk_score\x18\a \x01(\x01R\fminRiskScore\x12:\n" +
	"\x19monitoring_frequency_days\x18\b \x01(\x05R\x17monitoringFrequencyDays\x129\n" +
	"\n" +
	"created_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xde\x02\n" +
	"\x19RiskMonitoringRuleUpdated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_rule_uuid\x18\x02 \x01(\tR\friskRuleUuid\x12f\n" +
	"\x0eupdated_fields\x18\x03 \x03(\v2?.proto.scg.risk.v1.RiskMonitoringRuleUpdated.UpdatedFieldsEntryR\rupdatedFields\x129\n" +
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x1a@\n" +
	"\x12UpdatedFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_rule_uuid\x18\x02 \x01(\tR\friskRuleUuid\x12!\n" +
	"\factivated_by\x18\x03 \x01(\tR\vactivatedBy\x12=\n" +
	"\factivated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vactivatedAt\"\xff\x01\n" +
	"\x1dRiskMonitoringRuleDeactivated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12$\n" +
	"\x0erisk_rule_uuid\x18\x02 \x01(\tR\friskRuleUuid\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x12%\n" +
	"\x0edeactivated_by\x18\x04 \x01(\tR\rdeactivatedBy\x12A\n" +
	"\x0edeactivated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\rdeactivatedAt\"\xc2\x02\n" +
	"\x15RiskThresholdExceeded\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\x1b\n" +
	"\trisk_uuid\x18\x02 \x01(\tR\briskUuid\x12$\n" +
	"\x0erisk_rule_uuid\x18\x03 \x01(\tR\friskRuleUuid\x12%\n" +
	"\x0ethreshold_type\x18\x04 \x01(\tR\rthresholdType\x12%\n" +
	"\x0eprevious_value\x18\x05 \x01(\tR\rpreviousValue\x12#\n" +
	"\rcurrent_value\x18\x06 \x01(\tR\fcurrentValue\x12;\n" +
	"\vdetected_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"detectedAt\"\xff\x01\n" +
	"\x0eRiskKPICreated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\"\n" +
	"\rrisk_kpi_uuid\x18\x02 \x01(\tR\vriskKpiUuid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1f\n" +
	"\vmetric_type\x18\x04 \x01(\tR\n" +
	"metricType\x12!\n" +
	"\ftarget_value\x18\x05 \x01(\x01R\vtargetValue\x129\n" +
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xd2\x02\n" +
	"\x0eRiskKPIUpdated\x126\n" +
	"\x04meta\x18\x01 \x01(\v2\".proto.scg.shared.v1.EventEnvelopeR\x04meta\x12\"\n" +
	"\rrisk_kpi_uuid\x18\x02 \x01(\tR\vriskKpiUuid\x12%\n" +
	"\x0eprevious_value\x18\x03 \x01(\x01R\rpreviousValue\x12#\n" +
	"\rcurrent_value\x18\x04 \x01(\x01R\fcurrentValue\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status\x12E\n" +
	"\x10measurement_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0fmeasurementDate\x129\n" +
	"\n" +
	"updated_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtBDZBgithub.com/hbttundar/scg-contracts/gen/go/proto/scg/risk/v1;riskv1b\x06proto3"
